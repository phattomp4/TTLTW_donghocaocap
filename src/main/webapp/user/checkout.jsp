...
<div class="container" style="max-width: 1200px; margin: 0 auto; padding-top: 150px;">
    ...
    <form action="checkout" method="POST" class="checkout-form"
                    ...
                    <label for="cod"
                        ...
                        <div>
                            ...
                            <small style="color: #999;">
                                Nhận hàng rồi mới trả tiền mặt
                            </small>
                        </div>
        ...
        <div class="checkout-right-col"
             style="flex: 1; position: sticky; top: 150px;">
            ...
            <div class="checkout-summary"
                ...
                <h3 style="border: none; padding: 0; margin-bottom: 20px;">
                    Tóm tắt đơn hàng
                </h3>
    ...
    <div class="modal-box"
        ...
        <form action="checkout-address" method="POST">
            ...
            <div class="modal-footer"
                 style="text-align: right; border-top: 1px solid #eee; padding-top: 20px;">

                <button type="button"
                        onclick="closeModal()"
                        style="padding: 10px 25px; border-radius: 6px; border: 1px solid #ccc; background: #f8f8f8; cursor: pointer; margin-right: 10px; font-weight: bold;">

                    HỦY
                </button>

                <button type="submit"
                        style="padding: 10px 25px; border-radius: 6px; border: none; background: #c5a059; color: white; cursor: pointer; font-weight: bold; box-shadow: 0 4px 10px rgba(197, 160, 89, 0.3);">
