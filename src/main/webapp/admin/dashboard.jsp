...
<div class="content">
    ...
    <div class="dashboard-header">
        ...
        <div class="filter-group">
            ...
            <a href="export-statistics" class="btn-export">
                    ...
                    <tr>
                        ...
                        <td>
                            <c:choose>
                                ...
                                <c:otherwise><span class="badge" style="background:#eee; color:#666;">${o.status}</span></c:otherwise>
                            </c:choose>
                        </td>
                        ...
                        <td style="text-align: center;">
                            <c:choose>
                                <c:when test="${w.stockQuantity < 3}">
                                    <span class="badge badge-danger" title="Nguy cơ đứt hàng!">${w.stockQuantity} cản kiệt</span>
                                </c:when>
                                <c:otherwise>
